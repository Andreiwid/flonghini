...
/**
 * PalavrasChaveTrabalhoEmEvento
 *
 * @ORM\Table(name="palavras_chave_trabalho_em_evento")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\PalavrasChaveTrabalhoEmEventoRepository")
 */
class PalavrasChaveTrabalhoEmEvento
{
    /**
     * @var int
     *
     ...
     *
     * @return PalavrasChaveTrabalhoEmEvento
     */
    ...
    /**
     * Set trabalhoEmEvento
     *
     * @param string $trabalhoEmEvento
     *
     * @return PalavrasChaveTrabalhoEmEvento
     */
