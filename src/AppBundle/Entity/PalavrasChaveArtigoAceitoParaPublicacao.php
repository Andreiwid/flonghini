...
/**
 * PalavrasChaveArtigoAceitoParaPublicacao
 *
 * @ORM\Table(name="palavras_chave_artigo_aceito_para_publicacao")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\PalavrasChaveArtigoAceitoParaPublicacaoRepository")
 */
class PalavrasChaveArtigoAceitoParaPublicacao
{
    /**
     * @var int
     *
     ...
     *
     * @return PalavrasChaveArtigoAceitoParaPublicacao
     */
